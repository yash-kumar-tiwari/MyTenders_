                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item">
                            ...
                            <div class="d-flex align-items-center">
                                <img class="img-fluid rounded-circle" src="assets/img/testimonial-1.jpg" style={{"width": "80px", "height": "80px"}} alt="Image"/>
                                <div class="pl-4">
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="d-flex align-items-center">
                                <img class="img-fluid rounded-circle" src="assets/img/testimonial-2.jpg" style={{"width": "80px", "height": "80px"}} alt="Image"/>
                                <div class="pl-4">
                                    <h6 class="font-weight-bold">Client Name</h6>
                                    <i class="text-muted">Profession</i>
                                </div>
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="d-flex align-items-center">
                                <img class="img-fluid rounded-circle" src="assets/img/testimonial-3.jpg" style={{"width": "80px", "height": "80px"}} alt="Image"/>
                                <div class="pl-4">
                                    <h6 class="font-weight-bold">Client Name</h6>
                                    <i class="text-muted">Profession</i>
                                </div>
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="d-flex align-items-center">
                                <img class="img-fluid rounded-circle" src="assets/img/testimonial-4.jpg" style={{"width": "80px", "height": "80px"}} alt="Image"/>
                                <div class="pl-4">
                                    <h6 class="font-weight-bold">Client Name</h6>
                                    <i class="text-muted">Profession</i>
                                </div>
